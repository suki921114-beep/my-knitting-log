  ...
  return (
    <div>
      <PageHeader
        ...
        right={
          <Link to="/projects/new" className="inline-flex items-center gap-1 rounded-full bg-primary px-3.5 py-2 text-sm font-medium text-primary-foreground shadow-soft">
