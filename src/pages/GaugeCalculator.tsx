...
export default function GaugeCalculator() {
  ...
  return (
    <div className="space-y-5">
      ...
      {toast && (
        <div className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom,0px))] left-1/2 z-50 -translate-x-1/2 rounded-full bg-foreground px-4 py-2 text-[12px] font-semibold text-background shadow-pop">
          {toast}
        </div>
      )}
    </div>
